...
//   };
  ...
  // };
    ...
    // func computeFeatureGini(xcol: [mtkl.dataMember],y:[Text],y_uniques:[Text]): Result.Result<(Float,Float), mtkl.MotokoLearnError> {
    ...
    // func dataMemberVectorToTextVector(y: [mtkl.dataMember]): Result.Result<[Text], mtkl.MotokoLearnError> {
    //   let ysize = y.size();
    ...
    // func dataMemberVectorToFloatVector(y: [mtkl.dataMember]): Result.Result<[Float], mtkl.MotokoLearnError> {
    //   let ysize = y.size();
    ...
    //                        col_ids: [Nat]): Result.Result<BinTree, mtkl.MotokoLearnError> {
